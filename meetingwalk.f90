program randomocc
    ...
    real, parameter :: side_len=7000000
    real :: r_1, r_2
    integer, parameter :: steps= side_len, runs=1000
    ...
    do j=1, runs
        ...
        do i=2, steps
            ...
            rad(i) = abs(sqrt(path_1(1,i)**2 + path_1(2,i)**2)-sqrt(path_2(1,i)**2 + path_2(2,i)**2))
            if (rad(i) < 512) then
                hit = 1
            end if
        end do
